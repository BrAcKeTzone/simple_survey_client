...
const SurveyForm = () => {
  ...
  return (
    <div className="bg-purple-100 md:py-8">
              ...
              <Form>
                ...
                {questionsData.map((question) => (
                  ...
                  >
                    ...
                    {unansweredQuestions.includes(question.id) && (
                      <div className="text-red-500 mb-2 text-sm">Required</div>
                    )}
                    <div>
      ...
      <div className="">
        {/* Ignore this part of code for now.
         Appears a Pie chart for the answers selected each question. Another Pie
        chart for Gender filters. Another Pie chart for Age filters. A line
        graph for displaying how many answered today with filters from a
