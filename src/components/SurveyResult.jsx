...
const SurveyResult = () => {
    ...
    const [enlargedChartIndex, setEnlargedChartIndex] = useState(null);
    ...
    const getGenderCountsForChoice = (questionId, choice) => {
        const genderCounts = { Male: 0, Female: 0, "Non-binary": 0 };

        surveyResults.forEach(result => {
            const answer = result.answers[questionId];
            if (Array.isArray(answer)) {
                answer.forEach(selectedChoice => {
    ...
    const exportToCSV = () => {
        ...
        const columnHeaders = [
            ...
            "Gender",
            "Date Taken",
            ...questionsData.map(question => `"${question.qHeader}"`)
        ];
                ...
                <div className="bg-purple-100 md:py-8">
                    <div className="max-w-3xl mx-auto p-8 bg-gray-100 rounded-lg shadow-md border-t-8 border-purple-300">
                        <div className="flex flex-col mb-4">
                            ...
                            >
                                <IoReturnDownBackSharp className="text-2xl" />{" "}
                                Back to Survey
                            </Link>
                        ...
                        <div className="mb-8">
                            ...
                            <div className=" overflow-x-auto">
                                <LineChart
                                    width={600}
                                    height={400}
                                    data={Object.entries(trendData).map(
                                        ([date, count]) => ({
                                            date,
                                            count
                                        })
                                    ...
                                    <div className="grid grid-cols-1">
                                        ...
                                        <div className="mt-8 border border-black p-4">
                                            <h3 className="text-lg font-semibold mb-4">
                                                Comparison of Choices by Gender
                                            </h3>
                                            <div className="overflow-x-auto">
                                                <BarChart
                                                    width={600}
                                                    ...
                                                    data={question.choice_selections.map(
                                                        choice => ({
                                                            choice,
                                                            Male: getGenderCountsForChoice(
                                                                question.id,
                                                                choice
                                                            ).Male,
                                                            Female: getGenderCountsForChoice(
                                                                question.id,
                                                                choice
                                                            ).Female,
                                                            "Non-binary":
                                                                getGenderCountsForChoice(
                                                                    question.id,
                                                                    choice
                                                                )["Non-binary"]
                                                        })
